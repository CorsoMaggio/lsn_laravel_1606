<nav class="navbar navbar-expand-lg"
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active text-white" href="/">Homepage</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="/arrivals">Arrivi</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="/departures">Partenze</a>
                </li>
            </ul>
        </div>
    </div>
